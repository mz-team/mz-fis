        ...
        .action(function(){
            ...
            switch (cmd) {
                ...
                case 'clean':
                    ...
                    var include = options.include  ? glob(options.include, root) : (user_include ? user_include : null);
                    var exclude = options.exclude ? glob(options.exclude, root) : (user_exclude ? user_exclude : /\/WEB-INF\/cgi\//);
